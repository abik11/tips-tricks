...
* [**Git Web Links**](https://marketplace.visualstudio.com/items?itemName=reduckted.GitWebLinks) - get links to bitbucket or github repository straight from Visual Studio
