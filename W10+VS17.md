...
```
You can also check out to given commit (put commit hash instead of branch name), but take care cause it will cause [**HEAD detached**](#head-detached-from-<-hash->).<br />
